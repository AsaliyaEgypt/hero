...
if res ~= 200 then
print('\27[0;31m•════•|  𝚜𝚞𝚙𝚎𝚛 𝚑𝚎𝚛𝚘  |•════•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na•════•|  𝚜𝚞𝚙𝚎𝚛 𝚑𝚎𝚛𝚘  |•════•\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m•════•|  𝚜𝚞𝚙𝚎𝚛 𝚑𝚎𝚛𝚘  |•════•\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
print('\27[0;31m•════•|  𝚜𝚞𝚙𝚎𝚛 𝚑𝚎𝚛𝚘  |•════•n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end 
os.execute('lua DRAGON.lua')
end
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/AsaliyaEgypt/hero/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1860114886,1124610301,1882299320,1526889688}   
...
if tonumber(user_id) == tonumber(1860114886) then  
var = true 
elseif tonumber(user_id) == tonumber(1882299320) then
var = true  
elseif tonumber(user_id) == tonumber(1124610301) then
var = true  
elseif tonumber(user_id) == tonumber(1526889688) then
var = true  
...
os.execute('wget https://raw.githubusercontent.com/AsaliyaEgypt/hero/main/DRAGON.lua')
...
send(msg.chat_id_, msg.id_,' ⋆ اصدار سورس سوبر هيرو{ S:12✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/Youssef_offical"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
local Text = [[ 
[قناه سورس سوبر هيرو ادخل وتابع الجديد](t.me/SUPER_HERO84)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' 𝚜𝚞𝚙𝚎𝚛 𝚑𝚎𝚛𝚘 ', url="t.me/SUPER_HERO84"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SUPER_HERO84)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/SUPER_HERO84"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'نيينبن' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
「المبرمج يوسف لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓」
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ⋆ من أحسن السورسات على التليجرام سورس سوبر هيرو ⋆
...
send(msg.chat_id_,0," ⋆ الـعـضو  : {["..data.first_name_.."](t.me/SUPER_HERO84)}\n ⋆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⋆ عذرا  ↚ {["..data.first_name_.."](t.me/SUPER_HERO84)}\n ⋆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
[⍟ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾  𝚜𝚞𝚙𝚎𝚛 𝚑𝚎𝚛𝚘 ](t.me/SUPER_HERO84) 

[⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝙾𝙽 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙻𝙴 ](t.me/SUPER_HERO84)

[⍟ 𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙱𝙴𝙻𝙾𝚆 ](t.me/SUPER_HERO84)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/V_I_K_I_N_G_2/103/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'يوسف' or text == 'Ban.da' or text == 'baتnda' then
local Text = [[
المبرمج يوسف لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس سوبر هيرو؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس سوبر هيرو؟ ", 
"كم مره حبيت؟ ", 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/Youssef_offical)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل معنا', url="t.me/Youssef_offical"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/aslak8/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب سوبر هيرو' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ⋆ اهلا في قائمه الالعاب المتطوره سورس سوبر هيرو ⋆ 
...
if tonumber(result.sender_user_id_) == tonumber(1860114886) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1882299320) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1860114886) then
send(msg.chat_id_, msg.id_, " ⋆ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1882299320) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1882299320) then  
send(msg.chat_id_, msg.id_, " ⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/AsaliyaEgypt/hero/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⋆ اهلا بك في متجر ملفات سوبر هيرو\n ⋆ ملفات السورس ↓\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n•════•|  𝚜𝚞𝚙𝚎𝚛 𝚑𝚎𝚛𝚘  |•════•\n ⋆ علامة تعني { ✔️ } ملف مفعل\n ⋆ علامة تعني { ✖ } ملف معطل\n ⋆ قناة سورس سوبر هيرو↓\n".." ⋆ [اضغط هنا لدخول](t.me/SUPER_HERO84) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/AsaliyaEgypt/hero/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ⋆ عذرا الملف لايدعم سورس سوبر هيرو\n") 
end
return false
end
...
if text == ("مسح قائمه سوبر هيرو") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ⋆ تم مسح قائمه سوبر هيرو')
return false
end

if text == 'قائمه سوبر هيرو' and Sudo(msg) then
...
if #list == 0 then
t = " ⋆ لا يوجد احد في قائمه سوبر هيرو"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع سوبر هيرو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع سوبر هيرو@(.*)$") and Sudo(msg) then
local username = text:match("^رفع سوبر هيرو@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع سوبر هيرو(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع سوبر هيرو(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل سوبر هيرو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل سوبر هيرو@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل سوبر هيرو@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل سوبر هيرو(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل سوبر هيرو(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ⋆  الايدي بالصوره  ↚ { '..idph..
' }\n'..' ⋆  الرفع  ↚ { '..setadd..
' }\n'..' ⋆  الحظر  ↚ { '..banm..' }\n\n ⋆═───═❲[ 𝚜𝚞𝚙𝚎𝚛 𝚑𝚎𝚛𝚘 ](t.me/SUPER_HERO84)❳═───═ ⋆\n ⋆ قناة سورس سوبر هيرو↓\n [ ❲[ 𝚜𝚞𝚙𝚎𝚛 𝚑𝚎𝚛𝚘 ](t.me/SUPER_HERO84)❳](t.me/SUPER_HERO84) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'•════•|  𝚜𝚞𝚙𝚎𝚛 𝚑𝚎𝚛𝚘  |•════•\nاضغط علي الاسم ليتم نسخه\n•════•|  𝚜𝚞𝚙𝚎𝚛 𝚑𝚎𝚛𝚘  |•════•ٴ\n ⋆ ❲[ 𝚜𝚞𝚙𝚎𝚛 𝚑𝚎𝚛𝚘 ](t.me/SUPER_HERO84)❳ ⋆ ')
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "سوبر هيرو")
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سوبر هيرو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سوبر هيرو')
local DRAGON_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'سوبر هيرو')
local DRAGON_Msg = {
...
end --الكود حصري سورس سوبر هيرويعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سوبر هيرو').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/SUPER_HERO84)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SUPER_HERO84)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SUPER_HERO84)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SUPER_HERO84)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SUPER_HERO84)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SUPER_HERO84)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SUPER_HERO84)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SUPER_HERO84)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/SUPER_HERO84)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/SUPER_HERO84)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/SUPER_HERO84)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/SUPER_HERO84)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🌚♥️](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/SUPER_HERO84)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🌚💕](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/SUPER_HERO84)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚💕](t.me/SUPER_HERO84)')
return false
end
end
end
...
local Teext =[[
 ⋆   بك في مميزات سورس سوبر هيرو ⋆  
 ⋆   مميزات الخاصه بسورس ⋆ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="https://t.me/SUPER_HERO84/149"},{text = 'كتبات',url="https://t.me/SUPER_HERO84/155"}},   
{{text = 'انصحني', url="https://t.me/SUPER_HERO84/151"},{text = 'لو خيروك', url="https://t.me/SUPER_HERO84/152"}}, 
{{text = 'الصراحه', url="https://t.me/SUPER_HERO84/161"},{text = 'حروف', url="https://t.me/SUPER_HERO84/153"}}, 
{{text = 'رزله', url="https://t.me/SUPER_HERO84/156"},{text = 'رد عليه يابوت', url="https://t.me/SUPER_HERO84/160"}}, 
{{text = 'بتكره دا', url="https://t.me/SUPER_HERO84/157"},{text = 'نكته', url="https://t.me/SUPER_HERO84/154"}}, 
{{text = 'غنيلي', url="https://t.me/SUPER_HERO84/158"}},
{{text = 'نسبه جمالي', url="https://t.me/SUPER_HERO84/188"},{text = 'اليتيوب', url="https://t.me/SUPER_HERO84/194"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/SUPER_HERO84/138"},{text = 'لعبه الرياضيات',url="https://t.me/SUPER_HERO84/139"}},   
{{text = 'لعبه المختلف', url="https://t.me/SUPER_HERO84/148"},{text = 'لعبه السمايلات', url="https://t.me/SUPER_HERO84/141"}}, 
{{text = 'لعبه التخمين', url="https://t.me/SUPER_HERO84/143"},{text = 'لعبه العكس', url="https://t.me/SUPER_HERO84/144"}}, 
{{text = 'لعبه الاسرع', url="https://t.me/SUPER_HERO84/145"},{text = 'لعبه الانكليزي', url="https://t.me/SUPER_HERO84/146"}}, 
{{text = 'لعبه حزوره', url="https://t.me/SUPER_HERO84/142"},{text = 'لعبه المعاني', url="https://t.me/SUPER_HERO84/147"}}, 
{{text = 'لعبه الامثله', url="https://t.me/SUPER_HERO84/140"},{text = 'عقاب', url="https://t.me/SUPER_HERO84/198"}},
{{text = 'مريم', url="https://t.me/SUPER_HERO84/209"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = ' 𝚜𝚞𝚙𝚎𝚛 𝚑𝚎𝚛𝚘 ', url="t.me/SUPER_HERO84"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سوبر هيرو')
